<%@ Page Title="" Language="C#" MasterPageFile="~/TSFA.Master" AutoEventWireup="true" CodeBehind="DirectorGeneral_CEFNARM.aspx.cs" Inherits="TSFA.DirectorGeneral_CEFNARM" %>
...
<img src="images/PCCFCAMPA.jpeg" class="img-responsive" />
<h6></h6>
</div><!--col-md-4 col-sm-4 col-xs-12 close-->


<div class="col-md-5 col-sm-5 col-xs-12">
<h5>Sri Lokesh Jayaswal, IFS</h5>
<p>PCCF/Director General, CEFNARM Dulapally</p>
<ul>
...
<li><span class="fa fa-phone-square"></span> 040-29704896</li>
<li><span class="fa fa-envelope-open"></span>lokeshja9@gmail.com</li>
...
<div>
<%--<p style="text-align:justify;padding:0 60px 0 20px">Dr. G. Chandrashekar Reddy, a 1991 Batch Indian Forest Service Officer, presently working as Additional 
Principal Chief Conservator Of Forests/CF Hyderabad Circle, Hyderabad, <span style="font-weight:bold; color:Teal;";> Director (FAC), TSFA Dulapally </span>and Dean, Forest College and Research Institute, Hyderabad at Mulugu in Telangana State. 
He has 27 years of rich experience in Natural Resources Management and worked in the areas of Forest Management, Watershed Based Livelihoods Management, 
Drought And Flood Mitigation, Water Conservation and Water Use Efficiency, Participatory Irrigation Water Management, Eco- Friendly Coal Mining, Bio- Diesel, 
Environment Education, Wildlife Management etc. He worked as Project Director for DFID, JICA and world bank aided livelihoods & water sector projects in the state.
He served as course coordinator for the 86th and 87th foundation course for IFS officers and Indian Civil Services officer trainees at Dr.MCR HRD I conducted under 
the aegis of LBSNAA Missouri. He is a graduate in B.Sc. Forestry and post graduate in life sciences from JNU, New Delhi. He did his masters in management and public 
policy from IIM, Bangalore and Syracuse University, USA. He also holds a PG Diploma in Environmental Education and Management from HCU, Hyderabad. He was awarded doctoral
degree in environmental sciences from Kakatiya University.</p>--%>
</div>
