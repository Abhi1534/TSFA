<%@ Page Title="Anjane" Language="C#" MasterPageFile="~/TSFA.Master" AutoEventWireup="true" CodeBehind="Anjaneyulu.aspx.cs" Inherits="TSFA.Anjaneyulu" %>
...
<img src="images/Faculty/Anjaneyulu.jpg" class="img-responsive" />
<h6></h6>
</div><!--col-md-4 col-sm-4 col-xs-12 close-->


<div class="col-md-5 col-sm-5 col-xs-12">
<h5>Sri V.Anjaneyulu, SFS</h5>
<p>Dy.Director & Course Director (FRO-ITP Course)</p>
<ul>
...
<li><span class="fa fa-phone-square"></span> +91 9440815595</li>
<li><span class="fa fa-envelope-open"></span>vanjaneyulu.tsfa@gmail.com</li>
...
<div>
<p style="text-align:justify;padding:0 60px 0 20px">He is presently acting as Course Director for Forest Range Officer ITP Course, I/c of Trainings & vehicles. 
He has joined the Forest Department in 1993 and has 27 years of experience in the forestry & allied areas, worked in Geo-informatics O/o the PCCF, 
Social Forestry Karimnagar & as Sub-DFO, Mulugu. He is a Post Graduate in Mathematics and has post graduate diploma in Forestry.</p>
</div>
