<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="CategoryType.aspx.cs" Inherits="TSFA.Admin.CategoryType" %>
    ...
    <div class="page-wrapper">
        <div class="content container-fluid">
            ...
            <div class="page-header">
                <div class="row">
                    <div class="col-sm-12">
                        <h3 class="page-title">Category Type Master </h3>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4">
                                            <div class="form-group">
                                                ...
                                                <asp:TextBox runat="server" class="form-control" ID="txt_Category" />
                                        ...
                                        <table class="table mb-0">
                                            <asp:GridView ID="grid_data" runat="server" AutoGenerateColumns="false" AllowPaging="true" PageSize="2" AllowSorting="true"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Category Type ID" Visible="false">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lbl_CategoryTypeID" runat="server" Text='<%# Eval("ID")%>'></asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>

                                                    <asp:TemplateField HeaderText="Category Type Name">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lbl_CategoryTypeName" runat="server" Text='<%# Eval("CategoryName")%>'></asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    ...
                                                    <asp:TemplateField HeaderText="Is Active">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lbl_IsActive" runat="server" Text= '<%# Eval("isActive").ToString() == "1" ? "Active" : "InActive" %>'></asp:Label>
                                                    ...
                                                    <asp:TemplateField HeaderText="Action">
                                                        <ItemTemplate>
                                                            <asp:LinkButton runat="server" CommandArgument='<%# Eval("ID")%>' CommandName="Btn_EditCommand" ID="btn_Edit"><asp:image imageurl="../Images/edit.svg" runat="server" Height="20px" Width="20px" /></asp:LinkButton>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                </Columns>
                                            </asp:GridView>
