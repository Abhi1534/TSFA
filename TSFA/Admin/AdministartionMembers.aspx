                                ...
                                <asp:Panel runat="server" ID="pnl_view" Visible="true">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table mb-0">
                                            <asp:GridView ID="grid_data" Visible="true" runat="server" AutoGenerateColumns="false" AllowPaging="true" PageSize="10" AllowSorting="true" OnPageIndexChanging="grid_data_PageIndexChanging"
